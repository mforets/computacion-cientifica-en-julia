...
makedocs(
    ...
    pages=[
        ...
        "Herramientas básicas" => Any["Alcance"=>"basics/alcance.md",
        ...
        "Fundamentos de Julia" => Any["Tipos de datos básicos"=>"fundamentos/tipos_basicos.md",
        ...
        "Patrones de diseño" => Any["Generación de paquetes"=>"patrones/paquetes.md",
