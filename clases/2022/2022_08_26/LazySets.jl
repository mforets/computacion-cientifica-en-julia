...
# ╔═╡ fc785bde-2582-11ed-16f9-cf4417abc1ba
using LazySets, Plots

# ╔═╡ 0897965f-db51-4c24-afad-db52c9777f94
using AbstractTrees

# ╔═╡ ee59da84-2d2e-4468-927f-ee5954315c71
x = 1:10_000

# ╔═╡ 0a71dee9-53aa-48d2-a794-c5e72850d222
dump(x)

# ╔═╡ af289332-82f8-48f4-a631-67936f24e317
supertype(typeof(x))

# ╔═╡ a08b1f53-fe52-43d1-bc21-b6973d022b19
typeof(x) |> supertype |> supertype |> supertype |> supertype

# ╔═╡ be89603f-6fe3-4a04-8e97-ccd65a99c82c
AbstractTrees.children(x::Type) = subtypes(x)

# ╔═╡ e717a07a-0d06-44da-b4d0-3c8f1a8374d1
y = 1:2:10000

# ╔═╡ 6f58853b-7dad-4bcc-b759-1f67789b01eb
dump(y)

# ╔═╡ 044553e4-f87b-4019-8f4c-b32b03c0685b
y[3]

# ╔═╡ b414cbcb-f022-4323-af4b-cae508465588
collect(y)

# ╔═╡ f09cdaca-d5e3-49b4-a1d4-b5b440f5615b
print_tree(AbstractVector)

# ╔═╡ 0940ce27-9a52-45bc-8643-a38f21b6b14a
collect(1:10_000)

# ╔═╡ 61c5d2fe-618c-44ca-bf72-984c888ceb45
print_tree(Number)

# ╔═╡ 63da873c-cb19-40cc-bf57-81e22d6b4133
2//1

# ╔═╡ 80f1508b-0d24-4d7d-bc5a-930a58f9ef82
16 // 2

# ╔═╡ bfd58c73-174c-4fe7-bd95-28165f003686
H = HalfSpace([1.0, -1.0], 0.0) # x - y <= 0        x <= y

# ╔═╡ 1abac0e7-7010-4674-b7eb-0ea005431574
plot(H)

# ╔═╡ 112cc88a-dd44-47e9-bf2a-986b45ecde96
dump(H)

# ╔═╡ 9bd4bae6-0665-47ec-8fa4-f04db4ab8bb7
@which HalfSpace([1.0, -1.0], 0.0)

# ╔═╡ c215b3d6-ae6e-4622-9735-a2574ccf3455
print_tree(AbstractPolyhedron)
...
git-tree-sha1 = "b6ed1e3b381acd2f2340a084521e5471a2831019"
