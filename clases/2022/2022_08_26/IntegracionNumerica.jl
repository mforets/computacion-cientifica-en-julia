...
# ╔═╡ 6f8feba4-257f-11ed-0472-2fbf32f55763
using UnPack, DifferentialEquations, Plots, PlutoUI

# ╔═╡ 55da0588-2598-4ce2-ab9f-e9c786ab0447
Base.@kwdef struct RK4
    h::Float64
end

# ╔═╡ 7fabe0ad-78c8-4c94-96ed-19a3bcbfaba9
begin
...
function integrate(f::Function, alg::RK4, t0, T, x0)
    ...
    for k in 1:N-1
		# Actualizo los vectores x y t "in-place" (en el sitio).
        step!(f, x, k, t, h)
    end
    x, t
end
...
# ╔═╡ 997b83cf-a3a2-49ef-bbd2-f8373ede068d
@bind T Slider(1:8)

# ╔═╡ 23706f27-bcd1-4b38-a942-3c7df3788875
x, t = integrate(lotkavolterra, RK4(h=0.01), 0.0, T, ones(2))

# ╔═╡ 48421f19-6681-4c72-bb97-1c5060dd3927
begin
	prob = ODEProblem(lotkavolterra!, ones(2), (0.0, T))
	sol_prob = solve(prob, alg=DifferentialEquations.RK4())
end

# ╔═╡ 8fc721fb-31f3-4394-b52b-f1d026a95b6a
begin
	plot(sol_prob, idxs=(1, 2), lab="DiffEq")
	plot!(getindex.(x, 1), getindex.(x, 2), ls=:dash, lc=:red, lab="RK4")
end

# ╔═╡ 06e13215-5fab-4c7e-940d-3da0d14abf48
begin
struct Foo
	a::Float64
	b::Float64
...
# ╔═╡ b2e991fc-dcc3-412b-ad42-0d6c1f4487d8
begin
F1 = Foo(1, 2, 3)
F2 = Foo(4, 5, 6)
Z = Boo(F1, F2)
...
# ╔═╡ 39856a54-1ad2-4c75-9e3a-39f9f3ea401b
sol_prob.interp
